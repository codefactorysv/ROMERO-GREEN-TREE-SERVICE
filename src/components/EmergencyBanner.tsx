      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl bg-forest-950 px-6 py-10 sm:px-10 sm:py-12">
            ...
            <div
              aria-hidden
              className="pointer-events-none absolute -bottom-24 -left-10 size-64 rounded-full bg-forest-700/25 blur-3xl"
            />
            ...
            <div className="relative flex flex-col items-start gap-8 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-base leading-relaxed text-cream-100/75">
                  Emergency tree response is available 24/7. If a tree comes down on your
                  property, call us any time — day or night.
                </p>
              </div>
